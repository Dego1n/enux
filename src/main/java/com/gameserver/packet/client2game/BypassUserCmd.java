...
public class BypassUserCmd extends AbstractReceivablePacket {

    private static final Logger log = LoggerFactory.getLogger(BypassUserCmd.class);

    private ClientListenerThread clientListenerThread;

    public BypassUserCmd(ClientListenerThread listenerThread, byte[] packet) {
